        ...
        <div className="applications_card">
          ...
          <div className="services_box">
            ...
            <div className="services_given">
              ...
              Ethical and Responsible AI Framework Integration
            </div>
          </div>
          ...
          <h2>Our Offerings</h2>
          <p>Unlock the full creative potential of gen AI with our Generative AI solutions that help your team craft tailored roadmaps seamlessly integrating impactful use cases that drive innovation and efficiency.</p>
        </div>
      </div>
    </div>
  )
